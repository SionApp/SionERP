...
# Verificar configuración del backend si existe
if [ -d "$ROOT_DIR/apps/backend-go" ] && [ ! -f "$ROOT_DIR/apps/backend-go/.env" ]; then
...
echo ""
echo "💡 Consejo: Espera unos segundos a que todos los servicios estén listos"
