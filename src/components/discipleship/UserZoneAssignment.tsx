...
import { UserPlus, Search, MapPin, Users, Crown, Shield, Check, X } from 'lucide-react';
...
const UserZoneAssignment: React.FC<UserZoneAssignmentProps> = ({ onAssignment }) => {
      ...
      users.map(u =>
        u.id === user.id
          ? {
              ...
              discipleship_level:
                newRole === 'supervisor' ? 3 : newRole === 'server' ? 2 : u.discipleship_level,
  ...
  const handleRemoveFromZone = (user: AssignmentUser) => {
    setUsers(
      users.map(u =>
        u.id === user.id ? { ...u, zone_name: undefined, updated_at: new Date().toISOString() } : u
      )
    );
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        {!user.zone_name && <Badge variant="secondary">Sin zona asignada</Badge>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      <DialogContent className="sm:max-w-[425px]">
                        <DialogHeader>
                          <DialogTitle>Asignar {user.full_name} a Zona</DialogTitle>
                          <DialogDescription>
